...
function showResult(data) {
    ...
    // Update Text (Primary Result)
    const primary = data.primary;
    document.getElementById('soundClass').textContent = primary.class.replace(/_/g, ' ');
    document.getElementById('soundScore').textContent = primary.score;
    document.getElementById('resultSource').textContent = `Source: ${primary.source}`;

    const dangerBadge = document.getElementById('dangerLevel');
    dangerBadge.textContent = primary.danger_level;

    const safetyBadge = document.getElementById('safetyLevel');
    safetyBadge.textContent = primary.hearing_safety;

    // Update Badges Class
    dangerBadge.className = 'value badge'; // Reset
    safetyBadge.className = 'value badge';

    if (primary.danger_level === 'DANGER') {
        dangerBadge.classList.add('badge-danger');
        safetyBadge.classList.add('badge-danger');
    }
    else if (primary.danger_level === 'WARNING') {
    ...
    // Update Suggestion
    document.getElementById('suggestionText').textContent = primary.suggestion;
    ...
    // Update Secondary ML Result
    const ml = data.secondary_ml;
    document.getElementById('mlResult').textContent = `${ml.class} (${ml.score})`;
